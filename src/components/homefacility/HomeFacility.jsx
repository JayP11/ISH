        ...
        <div className="home-fac-sec">
            <div className="home-fac-flex container">
                ...
                <div className="home-fac-part2">
                    ...
                    <div className="home-fac-part2-inner-flex">
                        <div className="home-fac-roun-imgbox">
                            <img src={images.round_small_img_2} className="facility-small-img" />
                        </div>
                        <div className="home-fac-list-flex">
                            <p className="home-fac-list-head">Personalized Attention</p>
                            <p className="home-fac-list-txt">As the sole proprietor of the
                    ...
                    <div className="home-fac-part2-inner-flex">
                        <div className="home-fac-roun-imgbox">
                            <img src={images.round_small_img_3} className="facility-small-img" />
                        </div>

                        <div className="home-fac-list-flex">
                            <p className="home-fac-list-head">Relaxing and Tranquil Environment</p>
                            <p className="home-fac-list-txt">When you step into
